						...
						<div class="col-md-3 clearfix">
							...
							<div class="dropdown">
									<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
										...
										<span>Your Cart</span>
										<div class="qty " id="qtyCt"><?php echo e($cart->count()); ?></div>
									</a>
										...
										<div class="cart-list">
											...
											<div class="product-widget">
												<div class="product-img  ">
                                                    ...
                                                    <img src="./uploads/<?php echo e($item->attributes->image); ?>" alt="" class="cartImg">
                                                     <?php endif; ?>
												</div>
												<div class="product-body">
													<h3 class="product-name "><a href="#" class="cartName">product name: <?php echo e($item->name); ?>item</a></h3>
													<h4 class="product-price"><span class="qty itemQ"><?php echo e($item->quantity); ?>x</span><span class="cartPrice">$<?php echo e($item->price); ?></span></h4>
													<?php if( $item->attributes->has('priceBitcoin') ): ?>
    
													 <span class="bitPrice">bit coin <?php echo e($item->attributes->priceBitcoin); ?></span>
													 <?php endif; ?>
												</div>

												<a class="delete  delCart"  href="cart/delete/<?php echo e($item->id); ?>" ><i class="fa fa-close"></i></a>
											</div>

											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</div>
										<div class="cart-summary">
											<small><?php echo e($cart->count()); ?> Item(s) selected</small>
											<h5>SUBTOTAL: $<?php echo e($total); ?></h5>
										</div>
										<div class="cart-btns">
...
</html><?php /**PATH H:\job\ItCoreApps\task1(E-Commerce)\12-7\project\resources\views/master.blade.php ENDPATH**/ ?>