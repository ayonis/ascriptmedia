				...
				<div class="forms">
						...
						<div id="login">   
							...
							<form method="POST" action="{{ route('login') }}">
								...
								<input class="inputs{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" type="email"required autocomplete="off"/>
							...
							<div class="field-wrap">
								...
								<input class="inputs {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" type="password"required autocomplete="off"/>
							...
							<button class="button button-block">{{ __('Login') }}</button>
